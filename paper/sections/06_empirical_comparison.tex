...
\paragraph{The stablecoin path.} The sender pays the on-chain transfer fee (about 37 basis points for USDT-on-Tron at USD 400, 15 for a low-fee L1/L2 USDC transfer), the destination off-ramp basis, and the structural risk premium of Section~\ref{sec:risk_factors}.
