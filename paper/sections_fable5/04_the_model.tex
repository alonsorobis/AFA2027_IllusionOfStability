...
\end{align}
where $\mathbb{E}_\rho$ is the expectation under regime $\rho$. The counterparty component $\ell_C$ is the reduced-form credit term of Section~\ref{sub:counterparty}, evaluated at the one-year exposure window $T=1$ of the continuous-balance holder defined there and independent of the coordination stage; the two depeg components are the structural output of the global game. Their probability-weighted sum is the risk premium the holder bears,
